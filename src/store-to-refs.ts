import { ComputedRef, isReactive, isRef, toRaw, toRef, ToRef, ToRefs, WritableComputedRef } from '@vue-mini/core';
import { StoreGetters, StoreState } from './store';
import type { _ActionsTree, _GettersTree, _UnwrapAll, PiniaCustomStateProperties, StateTree, Store, StoreGeneric } from './types';
...
type _ToStateRefs<SS> =
  SS extends Store<string, infer UnwrappedState, _GettersTree<StateTree>, _ActionsTree>
...
export type StoreToRefs<SS extends StoreGeneric> =
  ...
  SS extends unknown ? _ToStateRefs<SS> & ToRefs<PiniaCustomStateProperties<StoreState<SS>>> & _ToComputedRefs<StoreGetters<SS>> : never;
