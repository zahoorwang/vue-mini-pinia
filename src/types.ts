// 参考：https://github.com/vuejs/pinia/blob/v2/packages/pinia/src/types.ts

import type { PersistenceOptions } from 'pinia-plugin-persistedstate';
import { ComputedRef, UnwrapRef, WatchOptions, WritableComputedRef } from '@vue-mini/core';

import { Pinia } from './root-store';
 ...
 */
export type StoreOnActionListenerContext<Id extends string, S extends StateTree, G /* extends GettersTree<S> */, A /* extends ActionsTree */> = _ActionsTree extends A
 ...
 */
export type StoreOnActionListener<Id extends string, S extends StateTree, G /* extends GettersTree<S> */, A /* extends ActionsTree */> = (
 ...
 */
export interface _StoreWithState<Id extends string, S extends StateTree, G /* extends GettersTree<StateTree> */, A /* extends ActionsTree */> extends StoreProperties<Id> {
  /**
 ...
 */
export interface PiniaCustomStateProperties<_S extends StateTree = StateTree> {}
 ...
 * of stores.
 */
export interface DefineStoreOptionsBase<S extends StateTree, _Store> {
  // NOTE: 附加在 pinia-plugin-persistedstate 插件中
  /**
 ...
 */
export interface DefineStoreOptions<Id extends string, S extends StateTree, G /* extends GettersTree<S> */, A /* extends Record<string, StoreAction> */>
